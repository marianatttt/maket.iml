...
function gridInit() {
   const items = document.querySelector('.articles_items')
   ...
   function documentActions(e) {
       ...
       if (targetElement.closest('.filter-articles_item')){
           const filterItem = targetElement.closest('.filter-articles_item');
           const filterValue = filterItem.dataset.filter;
           const filterActiveItem =  document.querySelector('.filter-articles_item.active');
